	...
	function mfthemes_sticky($number=10){?>
		<ul class="list">
			<?php $args = array(
				...
				$posts = query_posts($args); ?>
			<?php while(have_posts()) : the_post(); ?>
			<li class="widget-popular"><p><a href="<?php the_permalink() ?>" rel="bookmark" title="<?php the_title(); ?>"><?php the_title(); ?></a><span>[<?php if(function_exists('the_views')) the_views();echo getPostViews(get_the_ID());?>]</span></p></li>
